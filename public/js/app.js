...
function initAdmin() {
  ...
  // Join private room with unique name
  if (window.location.href.includes("/admin/orders")) {
    socket.emit("join2", "admin_orders");
  }
...
var order = hiddenInput ? JSON.parse(hiddenInput.value) : null;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_ecommerce_app"] = self["webpackChunkpizza_ecommerce_app"] || [];
